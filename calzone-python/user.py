...
app.config['MONGO_URI'] = "mongodb+srv://tharidhuphigera:P1JJiXPPo7k3ooSE@cluster0.s8fqejr.mongodb.net/CalzoneCapital?retryWrites=true&w=majority&appName=Cluster0"
mongo = PyMongo(app)
